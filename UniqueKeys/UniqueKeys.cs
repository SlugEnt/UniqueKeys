...
namespace SlugEnt {
    ...
    public class UniqueKeys {
        ...
        public UniqueKeys (string keySeparator = ":", string timeGuidSeparator = "_", bool keyIdentifierFirst = true, bool constantTimeGuid = false) {
            ...
            if ( _constantTimeGuid ) { _timeGuid = new TimeGuid (DateTime.Now); }
        }
        ...
        /// <returns></returns>
        public string GetKey (string uniqueIdentifier = "Key") { return IncrementKey (uniqueIdentifier); }
        ...
        private string FormatKey (string identifier) {
            ...
            if ( _keyIdentifierFirst ) { return identifier + _keySeparator + _timeGuid.ToString + keyIncVal; }
            else { return _timeGuid.ToString + keyIncVal + _keySeparator + identifier; }
        }
